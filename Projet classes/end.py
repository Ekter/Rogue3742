...
Hero_img=PhotoImage(file="images/hero_de_face_final.png")
sol_img1=PhotoImage(file="images/sol_1.png")
...
"""Goblin_im=PhotoImage(file="Gobelin.png")
Bow_im=PhotoImage(file="Bow.png")
Sword_im=PhotoImage(file="Sword.png")
gold_im=PhotoImage(file="Gold.png")
Blob_im=PhotoImage(file="Blob.png")
Chainmail_im=PhotoImage(file="Chainmail.png")
Bat_im=PhotoImage(file="Bat.png")
potionT_im=PhotoImage(file="PotionT.png")"""
potionH_im=PhotoImage(file="PotionH.png")
#Ork_im=PhotoImage(file="Ork.png")
